...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation/f:extension">
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/bci/StructureDefinition/shr-base-Topic-extension']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/us/bci/StructureDefinition/shr-base-Topic-extension': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Observation/f:extension/f:extension/f:valueCodeableConcept</sch:title>
    <sch:rule context="f:Observation/f:extension/f:extension/f:valueCodeableConcept">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Observation/f:extension/f:extension/f:valueCodeableConcept/f:coding</sch:title>
    <sch:rule context="f:Observation/f:extension/f:extension/f:valueCodeableConcept/f:coding">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
